...
exports.test = base.test.extend({
    ...
    grabs: ['/users/ceford/git/cefjdemos/manuals/user/', { option: true }],

    // The URL to use for default English screenshots.
    testurl: process.env.URL || 'http://localhost/jcms6user/',

    // The command line to use:
    // URL=http://localhost/jcms6user/administrator/index.php? LANGUAGE=en COUNTRY=en-GB  npx playwright test --project firefox --reporter dot
